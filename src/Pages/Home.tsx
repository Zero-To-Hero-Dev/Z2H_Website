        ...
        <div className="container mx-auto px-4 py-20 md:py-32">
          <div className="text-center animate-fadeInUp">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button icon={<Rocket className="w-5 h-5" />}>Get Started</Button>
              <Button variant="outline" icon={<Zap className="w-5 h-5" />}>Join Robotics Camp</Button>
              <Button variant="secondary" icon={<Phone className="w-5 h-5" />}>Contact Us</Button>
            </div>
          </div>
        </div>
